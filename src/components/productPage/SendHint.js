                  ...
                  <form>
                      <div className="send-hint__fields">
                          ...
                          <div className="send-hint__field">
                              ...
                              <input type="email" placeholder="Your Email" onChange={(e) => { setYourEmail(e.target.value) }} />
                          </div>

                          <div className="send-hint__field">
                              <label >Recipient's Name</label>
                              <input type="text" placeholder="Recipient's Name" required onChange={(e) => { setRecipientName(e.target.value) }} />
                          </div>

                          <div className="send-hint__field">
                              <label>Recipient's Email</label>
                              <input type="email" placeholder="Recipient's Email" required onChange={(e) => { setRecipientEmail(e.target.value) }} />
                          </div>
                      </div>
                      <div >
                          <button disabled={disableSendhint()} className="send-hint__submit " onClick={(e) => sendEmail(e)}>Send Hint</button>
                      </div>
                  </form>
              </div>
              }
